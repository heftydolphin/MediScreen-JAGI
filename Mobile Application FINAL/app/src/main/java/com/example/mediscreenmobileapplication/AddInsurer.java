...
public class AddInsurer extends AppCompatActivity {

    private String email;

    EditText emailEditText;

    Button searchInsurerButton;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        searchInsurerButton = findViewById(R.id.searchInsurerButton);

        searchInsurerButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (validate()){
                    ...
                    Toast.makeText(getApplicationContext(), "No Insurers with that email are\n" +
    ...
    private void searchForInsurer(){

        String URL = "http://192.168.43.216/Mobile_Application_Backend/searchInsurers.php";
            ...
            public void onResponse(String response) {
                ...
                try{
                    ...
                    if(success.equals("1")){
                        ...
                        //-------  SEND EMAIL TO INSURER WITH INVITE TO CONNECT ------
